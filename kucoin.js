...
async function getOrderbook() {
  try {
    //let data = await kucoin.getPartOrderBook({amount:100,symbol:"AVAX-USDT"});
...
async function getQuote(pair, fromSymbol, fromAmount) {
  ...
  if (fromSymbol == "AVAX".bids) {
    console.log("Sell fromAmount=", fromAmount, fromSymbol);
    console.log("orderBook", orderBook);
    console.log("orderBook.book", orderBook.book);
    console.log("orderBook.book.bids", orderBook.book.bids);
